      ...
      if (userDoc.exists() && problemDoc.exists()) {
        if (liked) {
          ...
          transaction.update(userRef, {
            ...
            dislikedProblems: userDoc.data().likedProblems.filter((id: string) => id !== problem.id),
          });
  ...
  return (
    <div className="bg-dark-layer-1">
      <div className="flex h-11 w-full items-center pt-2 bg-dark-layer-2 text-white overflow-x-hidden">
        <h1 className={"bg-dark-layer-1 rounded-t-[5px] px-5 py-[10px] text-xs cursor-pointer"}>Description</h1>
      </div>
        ...
        <div className="px-5">
          <div className="w-full">
            <div className="flex space-x-4">
              <h2 className="flex-1 mr-2 text-lg text-white font-medium">{problem.title}</h2>
            </div>
