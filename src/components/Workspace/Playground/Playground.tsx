        ...
        <div className="w-full px-5 overflow-auto">
          ...
          <div className="flex gap-3">
            {problem.examples.map((example, index) => (
              <div className=" items-start mt-2 text-white" key={example.id} onClick={() => setActiveTestCaseId(index)}>
                <div className="flex flex-wrap items-center gap-y-4">
                  <div
                    className={`font-medium items-center transition-all focus:outline-none 
                    inline-flex bg-dark-fill-3 hover:bg-dark-fill-2 relative rounded-lg 
